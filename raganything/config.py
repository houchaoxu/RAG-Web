...
class RAGAnythingConfig:
    ...
    mineru_backend: str = field(default=get_env_value("MINERU_BACKEND", "pipeline", str))
    """MinerU backend: 'pipeline' (fast OCR), 'hybrid-auto-engine' (accurate VLM), 'vlm-auto-engine'."""
